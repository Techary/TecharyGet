$folderPath = "c:\temp\MyDPDInstallation"
$logFile = "$folderPath\MyDPD-Install.log"
$filex64 = "$folderPath\MyDPD_Installer_x64.msi"
$filearm64 = "$folderPath\MyDPD_Installer-arm64.msi"
