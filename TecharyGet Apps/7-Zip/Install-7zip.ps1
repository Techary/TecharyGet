$folderPath = "c:\temp\7ZipInstallation"
$logFile = "$folderPath\7Zip-Install.log"
$filex64 = "$folderPath\7Zip_Installer_x64.msi"
$filearm64 = "$folderPath\7Zip_Installer-arm64.msi"
...
##          } | Where-Object { $_ -ne $null }
    ...
    Invoke-LogMessage "Successfully installed 7-Zip."
     catch {
    Invoke-LogMessage "Error installing 7-Zip: $($_.Exception.Message)"
}
