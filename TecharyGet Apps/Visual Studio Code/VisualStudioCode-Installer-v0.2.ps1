...
try {
    ...
    $yamlUrl = "https://raw.githubusercontent.com/microsoft/winget-pkgs/master/manifests/m/Mozilla/Firefox/${latestVersion}/Microsoft.VisualStudioCode.installer.yaml"
