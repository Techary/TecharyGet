...
#region Auto Complete App Name
Register-ArgumentCompleter -CommandName "Install-TecharyApp" -ParameterName "AppName" -ScriptBlock {
    param($commandName, $parameterName, $wordToComplete, $commandAst, $fakeBoundParameters)
    $apps = Get-TecharyAppMap
    $apps.Keys | Where-Object { $_ -like "$wordToComplete*" } | Sort-Object | ForEach-Object {
